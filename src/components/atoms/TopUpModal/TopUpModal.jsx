...
const TopUpModal = ({ openNext, handleOptionSelect, selectedOption }) => {
  return (
    <Container>
        ...
        <Option onClick={() => handleOptionSelect('card')}>
          ...
          <div className="contarinerBox">
            <div className="textContainer">
              ...
              <p>
                Credit Card fees will be deducted from your credits. These fees can significantly decrease your returns
      ...
      <Button width={'170'} height={'40px'} rounded sm btntype="primary" onClick={() => openNext()}>
        Continue
      </Button>
    </Container>
  );
