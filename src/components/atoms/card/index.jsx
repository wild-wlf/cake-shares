      ...
      <div className="card">
        ...
        <div className="decription">
          <div className="title-div">
            ...
            <span>{c_data?.currentBackers == 0 ? '0%' : (c_data?.currentBackers / c_data?.maximumBackers) * 100}</span>
          </div>

          <div className="progress">
            <ProgressBar
              completed={c_data?.currentBackers === 0 ? 0 : (c_data?.currentBackers / c_data?.maximumBackers) * 100}
              bgColor="#408F8C"
              height="5px"
              borderRadius="60px"
